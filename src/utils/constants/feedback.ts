export const feedbacks = {
  listening: {
    part1: {
      ...
      2: {
        feedback:
          'You’re catching some basic information, but you’re missing a lot of key details.',
        suggestions: [
          'Focus on practicing listening exercises that include common, everyday details, like appointments, dates, and locations.',
          'Use IELTS listening practice materials and set a goal to identify when details like names, numbers, or times are mentioned. Write them down and check your answers.',
          'Watch everyday situation dialogues on YouTube or language-learning apps, pausing frequently to ensure you’ve caught all the key points.'
        ]
      },
      3: {
        feedback:
      ...
      4: {
        feedback:
          'You’re doing better, but still missing some critical information, especially in listening for exact details.',
        suggestions: [
          'Focus on listening for keywords in sentences that contain numbers, names, or locations. These sections often hold the answer.',
          'Practice dictation exercises where you listen to audio and transcribe what you hear. This improves your ability to catch exact words.',
          'Start listening to slightly faster dialogues or conversations and try to repeat or write down the most important details.'
        ]
      },
      5: {
        feedback:
      ...
      6: {
        feedback: 'You’re performing well, but there are still some occasional missed details.',
        suggestions: [
          'Practice recognizing synonyms or paraphrasing. The IELTS often uses words or phrases that have similar meanings to the answer.',
          'Speed up your practice audio by 1.25x or 1.5x speed to challenge yourself and make it easier to catch information during normal-speed audio later on.'
        ]
      },
      7: {
        feedback: 'You’re performing well, but there are still some occasional missed details.',
      ...
      8: {
        feedback:
          'You’re nearly perfect! Your listening skills are strong, but you may still miss subtle information due to minor distractions or indirect phrasing.',
        suggestions: [
          'Focus on improving your ability to follow slightly more complex dialogues where there may be interruptions or changes in the direction of conversation.',
          'Continue practicing, but increase the difficulty of materials by listening to podcasts or radio shows where multiple people speak and the content is fast-paced.',
          'Try mock tests to simulate the pressure of the real exam environment.'
        ]
      },
      9: {
        feedback:
          'You’re nearly perfect! Your listening skil     ls are strong, but you may still miss subtle information due to minor distractions or indirect phrasing.',
        suggestions: [
          'Focus on improving your ability to follow slightly more complex dialogues where there may be interruptions or changes in the direction of conversation.',
          'Continue practicing, but increase the difficulty of materials by listening to podcasts or radio shows where multiple people speak and the content is fast-paced.',
          'Try mock tests to simulate the pressure of the real exam environment.'
      ...
      10: {
        feedback: 'Excellent! You have a firm grasp on this section.',
        suggestions: [
          'To maintain and refine your skills, challenge yourself by listening to authentic materials such as podcasts, interviews, or news reports on diverse topics.',
          'Experiment with different accents (e.g., British, Australian) to broaden your listening comprehension. Use sources like BBC, Australian news, or documentaries.'
        ]
      }
    ...
    part2: {
      0: {
        feedback:
          'You’re having difficulty following the monologue and picking out key details, which suggests you may not be accustomed to understanding extended speech.',
        suggestions: [
          'Begin by practicing with short monologues or TED Talks (with subtitles). Stop after every few sentences and summarize what was said.',
          'Pay attention to the structure of the talk: typically, the speaker will introduce the topic, give details, and conclude with a final thought.'
        ]
      },
      1: {
        feedback:
      ...
      2: {
        feedback:
          'You’re catching some parts of the talk, but important points or details are getting lost.',
        suggestions: [
          'Focus on identifying the main idea of each part of the talk. This will help you know which sections to pay closer attention to.',
          'Listen to informational podcasts or guided tours on topics that interest you, and practice summarizing the speaker’s main points and specific details.',
          'Use the transcript while listening to note down when the speaker gives key information, then try listening without the transcript and replicating that process.'
        ]
      },
      3: {
        feedback:
      ...
      4: {
        feedback:
          'You’re improving and can follow the speaker’s general flow but still miss some details.',
        suggestions: [
          "Work on listening for transitional words (e.g., 'first,' 'next,' 'finally') that guide you through the talk and signal important information is coming.",
          'Practice with longer audio files where you need to pick out specific details and examples.'
        ]
      },
      5: {
        feedback:
        ...
        suggestions: [
          "Work on listening for transitional words (e.g., 'first,' 'next,' 'finally') that guide you through the talk and signal important information is coming.",
          'Practice with longer audio files where you need to pick out specific details and examples.',
          'Try listening to audiobooks of nonfiction texts and summarize each chapter or section to help with understanding extended speech.'
        ]
      },
      6: {
        feedback:
          'You’re following the monologue well but may miss smaller details or indirect points.',
        suggestions: [
          'Practice listening to audio that involves a lot of descriptive language. Focus on how the speaker organizes the details and what examples or anecdotes they use.',
          'Work on your note-taking while listening, so you can quickly jot down key information. Then, go back to see if the notes match what was asked.',
          'Start listening to more specialized talks on unfamiliar topics to train your ear to recognize vocabulary you may not know.'
        ]
      },
      7: {
        feedback:
      ...
      8: {
        feedback: 'You’re doing great and only missing occasional minor details.',
        suggestions: [
          'Continue practicing with more complex academic or professional talks. TED Talks, university lectures, or even expert panels are good resources.',
          'Focus on improving your focus and concentration during the listening test. Make sure you don’t drift off during long parts of the monologue.',
          'Test yourself with fast-paced audio and challenge yourself by answering more complex questions.'
        ]
      },
      9: {
        feedback: 'You’re doing great and only missing occasional minor details.',
      ...
      10: {
        feedback: 'You’ve mastered Part 2!',
        suggestions: [
          'To push your skills further, challenge yourself with longer and more nuanced lectures or academic talks where multiple complex points are made.',
          'Work on summarizing complex talks and comparing how different speakers deliver similar types of information to improve your interpretation of details.'
        ]
      }
    } as Record<number, { feedback: string; suggestions: string[] }>,
    part3: {
      0: {
        feedback:
          'You’re struggling with understanding the flow of discussion and differentiating between speakers’ opinions.',
        suggestions: [
          'Start practicing with basic dialogues that involve more than one speaker. Focus on understanding the roles and perspectives of each speaker.',
          'Use conversation practice exercises where speakers debate or share opinions. Try noting down what each speaker’s main point is.',
          'Practice recognizing tone and emphasis, as these can often indicate disagreement or opinion changes.'
        ]
      },
      1: {
        feedback:
      ...
      2: {
        feedback:
          'You’re able to catch some parts but may miss who is speaking or the gist of the discussion.',
        suggestions: [
          'Focus on identifying the transition points in the conversation—when one speaker finishes and another starts.',
          'Listen to group discussions or interviews where multiple speakers participate. Focus on picking out each speaker’s main idea and write a summary of what each person said.',
          'Try dialogue-heavy podcasts or radio discussions and practice identifying when and how speakers disagree or build on each other’s points.'
        ]
      },
      3: {
        feedback:
      ...
      4: {
        feedback:
          'You’re improving but may miss the connections between speakers’ ideas or fail to understand the flow of the argument.',
        suggestions: [
          "Practice listening for contrast words (e.g., 'but,' 'however') that signal when speakers disagree.",
          'Focus on how the speakers connect their opinions and build upon each other’s ideas in the conversation. Re-listen to conversations and trace how one point leads to the next.',
          'Use IELTS practice tests for Part 3 and pay special attention to the speakers’ arguments and counterarguments.'
        ]
      },
      5: {
        feedback:
      ...
      6: {
        feedback:
          'You’re following most of the discussion, but might miss subtle disagreements or supporting points.',
        suggestions: [
          'Practice with discussions where speakers have similar but slightly differing opinions. Focus on catching nuances in how they speak.',
          'Listen to group discussions or academic panels on topics where there is debate or discussion of opinions, and identify how speakers position their views.',
          'Work on refining your ability to listen for supporting examples used by different speakers to back up their ideas.'
        ]
      },
      7: {
        feedback:
      ...
      8: {
        feedback:
          'You’re nearly perfect but might miss very minor details or subtle shifts in tone.',
        suggestions: [
          'To challenge yourself further, listen to philosophical or debate podcasts, where multiple speakers discuss abstract ideas. Focus on how each speaker defends or refutes points.',
          'Increase your exposure to complex group discussions and focus on the order in which ideas are presented and resolved.',
          'Simulate test conditions with mock tests that involve fast-paced, complex discussions to refine your comprehension.'
        ]
      },
      9: {
        feedback:
      ...
      10: {
        feedback: 'You’re excelling in this section!',
        suggestions: [
          'Keep refining your listening skills with challenging discussion formats. Look for panel discussions, academic debates, or even podcasts where multiple speakers discuss intricate topics.',
          'Push your skills further by listening to fast-paced, argumentative conversations where speakers interrupt each other or switch topics quickly.'
        ]
      }
    } as Record<number, { feedback: string; suggestions: string[] }>,
    part4: {
      0: {
        feedback: 'You’re struggling with understanding complex academic language and ideas.',
        suggestions: [
          'Start by building your academic vocabulary. Focus on common academic terms, as they are frequently used in lectures.',
          'Listen to short academic talks or university lectures with transcripts. Follow along, highlighting key points.',
          'Focus on understanding the structure of academic talks. They often present a thesis, followed by supporting arguments or examples. Understanding this flow will help you catch the main points.'
        ]
      },
      1: {
        feedback: 'You’re struggling with understanding complex academic language and ideas.',
      ...
      2: {
        feedback: 'You’re missing key points but can sometimes follow the main argument.',
        suggestions: [
          'Work on identifying the key points in academic talks. These talks are often filled with detail, but the key points are what the questions will ask about.',
          'Practice with more challenging academic listening tasks that focus on specific fields of study (e.g., science, history).',
          'Take notes as you listen. Note-taking will help you identify and remember the most important details of the talk.'
        ]
      },
      3: {
        feedback: 'You’re missing key points but can sometimes follow the main argument.',
      ...
      4: {
        feedback: 'You’re following the main argument but may miss supporting details or examples.',
        suggestions: [
          'Focus on catching specific details and examples that support the speaker’s main ideas.',
          'Work on paraphrasing. Often, academic listening passages will use synonyms or slightly altered phrases from the question. Practice recognizing this.',
          'Listen to documentaries or university lectures in English, focusing on how examples are presented to support a point.'
        ]
      },
      5: {
        feedback: 'You’re following the main argument but may miss supporting details or examples.',
      ...
      6: {
        feedback: 'You’re doing well, but you might miss occasional details or secondary examples.',
        suggestions: [
          'Practice with more complex academic lectures that present multiple arguments or viewpoints.',
          'Focus on identifying the relationship between ideas—how one idea leads to another. This will help you understand complex topics better.',
          'Use IELTS practice tests to simulate test conditions and refine your ability to capture small, but important, details.'
        ]
      },
      7: {
        feedback: 'You’re doing well, but you might miss occasional details or secondary examples.',
      ...
      8: {
        feedback: 'You’re handling academic listening very well, missing only very fine points.',
        suggestions: [
          'Continue improving by listening to advanced-level academic talks, such as university lectures or research presentations.',
          'Focus on identifying contradictions or counterarguments in academic talks. This is a higher-level skill that will help you fully understand the depth of the discussion.',
          'Try increasing the difficulty of your listening practice by using faster audio and more technical subjects.'
        ]
      },
      9: {
        feedback: 'You’re handling academic listening very well, missing only very fine points.',
      ...
      10: {
        feedback: 'You’ve mastered this section!',
        suggestions: [
          'To push your skills further, listen to specialized academic podcasts or university lectures from top universities (e.g., Harvard, MIT).',
          'Focus on improving your ability to summarize. After listening to a lecture, try summarizing the key points in your own words.',
          'Practice listening to talks on topics outside your area of expertise to ensure you’re prepared for any subject matter on the test.'
        ]
      }
    } as Record<number, { feedback: string; suggestions: string[] }>
  },
  reading: {
    part1: {
      0: {
        feedback:
          'You’re missing most of the basic facts and details in this passage, suggesting that you’re struggling with scanning and recognizing key information.',
        suggestions: [
          'Start practicing scanning techniques—quickly looking for specific words, dates, or phrases in a text. Use simple reading exercises where you practice locating information without reading everything.',
          'Work on understanding the structure of factual texts, which often follows a clear, logical order. Understanding this structure can help you anticipate where important information will appear.',
          'Use timed reading exercises to improve your speed while reading. Set a time limit for each passage and work on answering questions efficiently.'
        ]
      },
      1: {
        feedback:
      ...
      3: {
        feedback:
          'You’re catching some facts, but a lot of key information is still getting missed.',
        suggestions: [
          'Improve your scanning and skimming skills by reading simpler factual texts and noting down names, dates, or other important details.',
          'Focus on identifying keywords in the questions and matching them to the passage. Practice with easier texts where you find specific information quickly.',
          'Work on understanding synonyms and paraphrasing. The test often rephrases information from the passage, so you’ll need to recognize when the same idea is expressed differently.'
        ]
      },
      4: {
        feedback:
      ...
      5: {
        feedback:
          'You’re getting more correct, but you’re still missing some important facts or failing to find information fast enough.',
        suggestions: [
          'Practice reading factual texts from newspapers or magazines and work on picking out key pieces of information quickly.',
          'Focus on improving your ability to scan the passage for details without getting bogged down in unnecessary information.',
          'Use IELTS practice materials to practice time management. Set a goal of finding specific information within a set time frame.'
        ]
      },
      6: {
        feedback:
      ...
      7: {
        feedback:
          'You’re doing well but may miss details or get caught up in unnecessary information.',
        suggestions: [
          'Continue working on improving your speed and accuracy by practicing with more complex factual texts. Try to find answers quickly without re-reading the passage multiple times.',
          'Focus on identifying when paraphrasing is used in questions and answers. Look for sentences where the meaning is similar but expressed differently.',
          'Challenge yourself with more detailed factual texts that include statistics, dates, and data, and work on summarizing the main points.'
        ]
      },
      8: {
        feedback:
      ...
      9: {
        feedback:
          'You’re close to mastering this passage, but might miss very minor details or struggle with tricky paraphrasing.',
        suggestions: [
          'Keep practicing with increasingly difficult factual texts to improve your accuracy and speed.',
          'Try mock tests under timed conditions to improve your time management further.',
          'Focus on identifying nuanced differences between the correct answer and distractors (wrong answers) in multiple-choice questions. This will improve your ability to choose the most precise answer.'
        ]
      },
      10: {
        feedback:
      ...
      11: {
        feedback: 'Excellent work! You’ve mastered this passage.',
        suggestions: [
          'To maintain your skills, keep practicing with timed reading exercises to ensure you can consistently finish within the time limits.',
          'Challenge yourself with more complex factual materials such as scientific articles or reports.',
          'Focus on identifying the author’s purpose and tone, as these are sometimes tested, even in factual texts.'
        ]
      },
      12: {
        feedback: 'Excellent work! You’ve mastered this passage.',
    ...
    part2: {
      0: {
        feedback:
          'You’re missing key points and struggling to identify the author’s main argument or opinion.',
        suggestions: [
          'Start with simpler opinion-based texts, like opinion articles in newspapers, and practice identifying the main idea and supporting points.',
          'Focus on improving your skimming and scanning skills to quickly locate where the author presents their argument or introduces new ideas.',
          'Practice identifying the author’s tone (e.g., positive, negative, neutral) and viewpoint. Try reading shorter opinion pieces and summarizing the main point and tone.'
        ]
      },
      1: {
        feedback:
      ...
      3: {
        feedback:
          'You’re identifying some of the author’s opinions but still missing key details or misunderstand how ideas are connected.',
        suggestions: [
          'Practice reading opinion articles or essays that present arguments, and focus on identifying the main argument and the evidence used to support it.',
          "Improve your ability to find context clues. Look for transitions like 'however,' 'in contrast,' or 'similarly' to understand how the ideas connect.",
          'Work on improving your vocabulary to help you understand more abstract or complex texts.'
        ]
      },
      4: {
        feedback:
      ...
      5: {
        feedback:
          'You’re improving but may still miss key opinions or fail to understand how the author builds their argument.',
        suggestions: [
          'Focus on connecting the author’s ideas throughout the text. Practice identifying how one paragraph builds upon the next.',
          'Work on recognizing the difference between fact and opinion. The author’s argument often includes facts, but the questions might ask about their personal view.',
          'Use IELTS practice tests for opinion-based passages and work on identifying the author’s main viewpoint quickly.'
        ]
      },
      6: {
        feedback:
      ...
      7: {
        feedback:
          'You’re doing well, but might miss minor points or misunderstand subtle aspects of the argument.',
        suggestions: [
          'Practice with more complex opinion articles where the author discusses multiple viewpoints or presents a nuanced argument.',
          'Focus on identifying supporting details that back up the author’s argument.'
        ]
      },
      8: {
        feedback:
        ...
        suggestions: [
          'Practice with more complex opinion articles where the author discusses multiple viewpoints or presents a nuanced argument.',
          'Focus on identifying supporting details that back up the author’s argument. Try to understand why the author chose specific examples.',
          'Work on your ability to infer meaning from context. Often, you’ll need to understand what the author implies, rather than what they explicitly say.'
        ]
      },
      9: {
        feedback: 'You’re performing well, but might miss very subtle opinions or indirect ideas.',
        suggestions: [
          'Continue working on improving your ability to detect nuances in the author’s argument. Focus on identifying subtle shifts in tone or viewpoint.',
          'Challenge yourself with more abstract texts (e.g., philosophical essays, complex opinion pieces) to improve your ability to understand challenging viewpoints.',
          'Use IELTS practice tests under timed conditions to improve your ability to quickly identify key arguments and opinions.'
        ]
      },
      10: {
        feedback: 'You’re performing well, but might miss very subtle opinions or indirect ideas.',
      ...
      11: {
        feedback: 'Excellent work! You’re almost perfect in this passage.',
        suggestions: [
          'To maintain your high level, practice with advanced opinion-based materials like academic essays or articles in scholarly journals.',
          'Focus on improving your ability to understand complex reasoning.'
        ]
      },
      12: {
        feedback: 'Excellent work! You’re almost perfect in this passage.',
        suggestions: [
          'To maintain your high level, practice with advanced opinion-based materials like academic essays or articles in scholarly journals.',
          'Focus on improving your ability to understand complex reasoning. Look for how authors develop multi-layered arguments and present counterarguments.'
        ]
      },
      13: {
        feedback: 'Excellent work! You’re almost perfect in this passage.',
        suggestions: [
          'To maintain your high level, practice with advanced opinion-based materials like academic essays or articles in scholarly journals.',
          'Focus on improving your ability to understand complex reasoning.',
          'Keep practicing under exam conditions to ensure you can maintain your performance under pressure.'
        ]
      }
    } as Record<number, { feedback: string; suggestions: string[] }>,
    part3: {
      0: {
        feedback: 'You’re struggling to understand the passage’s complex ideas and vocabulary.',
        suggestions: [
          'Start practicing with simpler academic articles or textbooks on topics that interest you. Focus on understanding the main argument and key points.',
          'Build your academic vocabulary. Many academic texts use specific technical terms, so improving your understanding of common terms will help.',
          'Practice paraphrasing. The IELTS often tests your ability to recognize when the same idea is expressed using different words.'
        ]
      },
      1: {
        feedback: 'You’re struggling to understand the passage’s complex ideas and vocabulary.',
      ...
      3: {
        feedback:
          'You’re catching some of the main ideas but missing important details or getting confused by difficult vocabulary.',
        suggestions: [
          'Focus on improving your ability to understand the structure of academic texts. Many passages will introduce an idea, provide evidence, and conclude with implications or a summary.',
          'Practice with more challenging academic reading materials, such as research articles or university-level textbooks.',
          'Work on understanding complex sentences. Academic texts often contain long, complex sentences with multiple clauses, so breaking them down will help you understand the meaning.'
        ]
      },
      4: {
        feedback:
      ...
      5: {
        feedback:
          'You’re improving, but still missing important points or struggling to understand the overall argument.',
        suggestions: [
          'Practice reading academic texts on a variety of topics to improve your ability to quickly grasp complex ideas.',
          'Focus on understanding how the author develops their argument over the course of the passage. Many academic texts present a thesis and then back it up with evidence.',
          'Work on identifying key transitions between ideas, such as cause-and-effect relationships or comparisons.'
        ]
      },
      6: {
        feedback:
      ...
      7: {
        feedback:
          'You’re doing well, but may still miss subtle details or fail to fully understand the most complex parts of the passage.',
        suggestions: [
          'Continue practicing with more complex academic texts. Focus on improving your ability to understand abstract ideas and complex reasoning.',
          'Focus on identifying how the author uses examples or case studies to support their main points. Understanding the purpose of these examples can help you answer questions more accurately.',
          'Work on identifying relationships between ideas, such as contrasting views or supporting arguments.'
        ]
      },
      8: {
        feedback:
      ...
      9: {
        feedback:
          'You’re performing very well but may miss very minor details or struggle with extremely difficult vocabulary.',
        suggestions: [
          'Challenge yourself with more difficult academic texts in areas you’re less familiar with. This will help you improve your ability to quickly adapt to unfamiliar topics.',
          'Focus on identifying implied meanings or ideas that are not explicitly stated. The IELTS often tests your ability to infer meaning from context.',
          'Continue practicing under timed conditions to improve your ability to quickly find and understand key information.'
        ]
      },
      10: {
        feedback:
      ...
      11: {
        feedback: 'Excellent performance! You’ve mastered this passage.',
        suggestions: [
          'Keep challenging yourself with advanced academic materials, such as academic journals or university textbooks. Focus on improving your ability to understand the author’s purpose and complex reasoning.',
          'Practice summarizing academic texts in your own words, focusing on the main argument, supporting evidence, and implications.',
          'Take mock tests regularly to maintain your high level of performance and ensure you can handle the most difficult passages under timed conditions.'
        ]
      },
      12: {
        feedback: 'Excellent performance! You’ve mastered this passage.',
